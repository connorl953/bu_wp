	...
	<div class="container">
		<div class="row">
			<div class="col">
				...
				<div class="add-btn"><a href="#" data-id="<?php echo $post -> ID; ?>" data-user="<?php if($validUser){ echo 1; }else{ echo 0; } ?>"><?php if(count($isFavourite) > 0){ ?><i class="fa fa-check"></i> Added To Favourites<?php }else{ ?><i class="fa fa-plus"></i> to Favourites<?php } ?></a></div>
				<?php 
