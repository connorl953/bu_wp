...
class Image_Caption_Hover_CPT
{
    ...
    */
    ...
    function render_ich_shortcode($atts){
        ...
        // wp_enqueue_style( 'wcp-cute-grid', plugin_dir_url( __FILE__ ). 'css/cutegrids.css');
    ...
    function ichcpt_pro_mb(){
        ?>
            ...
            <ol>
                ...
                <li><?php _e( 'Masonry Grid', 'image-caption-hover' ); ?></li>
                <li><?php _e( 'Slider Carousel (Touch Supported)', 'image-caption-hover' ); ?></li>
    ...
    function get_free_effects(){
        $hoverEffects = array(
                ...
                'scroll-image-bottom-caption',
                'scroll-image-top-caption',
        );
