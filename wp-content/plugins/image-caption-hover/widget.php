...
class Image_Caption_Hover_Widget extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array( 'classname' => 'wcp_caption', 'description' => 'This widget is deprecated, please use other one.' );
        parent::__construct( 'wcp_caption', 'Image Caption Hover (Deprecated)', $widget_ops );
    }
...
add_action( 'widgets_init', 'register_ich_widget' );

function register_ich_widget(){
	register_widget( 'Image_Caption_Hover_Widget' );
}
